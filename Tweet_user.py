...
class SentimentAnalysis():
    ...
    def DownloadData(self, searchTerm, NoOfTerms):
        ...
        csvWriter.writerow(self.tweet_id)
        csvFile.close()
        '''
        #PRINT USER ID OF THE TWEET
        ...
        #return polarity, positive, wpositive, spositive, negative, wnegative, snegative, neutral, searchTerm;
